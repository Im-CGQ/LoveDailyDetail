...
-- 创建电影房间成员表
CREATE TABLE IF NOT EXISTS movie_room_members (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_movies_partner_id ON movies(partner_id);
...
CREATE INDEX IF NOT EXISTS idx_movie_rooms_creator_id ON movie_rooms(creator_id);
CREATE INDEX IF NOT EXISTS idx_movie_rooms_movie_id ON movie_rooms(movie_id);
CREATE INDEX IF NOT EXISTS idx_movie_room_members_room_id ON movie_room_members(room_id);
CREATE INDEX IF NOT EXISTS idx_movie_room_members_user_id ON movie_room_members(user_id);
CREATE INDEX IF NOT EXISTS idx_movie_room_members_is_online ON movie_room_members(is_online);
